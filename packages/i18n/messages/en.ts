...
3. Accept that the app is being installed. Once the app is installed, you should be redirected to the log-in. You will also find a new KlickerUZH icon on your home screen.
  ...
  manage: {
    ...
    aiRelate: {
      ...
      helpEval: 'This question effectively helps in saving time and effort when preparing lecture materials and assessments.',
      diffEval: 'The difficulty level categorization is appropriate for the generated question.',
      typeEval: 'The type of question is suitable for the content and effectively assesses understanding.',
      relaEval: 'This question is relevant to the context of the provided content and captures important knowledge.',
    },
    support: {
