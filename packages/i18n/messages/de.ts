...
3. Akzeptieren Sie, dass die App installiert wird. Sobald die App installiert ist, sollten Sie zum Log-in weitergeleitet werden. Sie werden auch ein neues KlickerUZH-Symbol auf Ihrem Startbildschirm finden.
  ...
  manage: {
    ...
    aiRelate: {
      ...
      strongAgree: 'Stark Zustimmen',
      strongDisagree: 'Stark Widersprechen',
      neutral: 'Neutral',
      help: 'Helfen Sie uns, das Erlebnis zu verbessern',
      extent: 'Inwieweit stimmen Sie der folgenden Aussage zu?',
      helpEval: 'Diese Frage hilft effektiv dabei, Zeit und Mühe bei der Vorbereitung von Unterrichtsmaterialien und Prüfungen zu sparen.',
      diffEval: 'Die Einstufung des Schwierigkeitsgrades ist für die gestellte Frage angemessen.',
      typeEval: 'Die Art der Fragen ist dem Inhalt angemessen und bewertet das Verständnis effektiv.',
      relaEval: 'Diese Frage ist relevant für den Kontext des vermittelten Inhalts und erfasst wichtiges Wissen.',
    },
    support: {
