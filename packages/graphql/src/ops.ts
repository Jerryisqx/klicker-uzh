...
export type RateQuestion = {
  ...
  helpfulness: Scalars['Int']['output'];
  id: Scalars['Int']['output'];
...
export type RateQuestionMutation = { __typename?: 'Mutation', rateQuestion?: { __typename?: 'RateQuestion', id: number, helpfulness: number, difficultyRate: number, typeRate: number, relevance: number } | null };
...
export const RateQuestionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RateQuestion"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"helpfulness"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"difficultyRate"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"typeRate"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"relevance"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rateQuestion"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"helpfulness"},"value":{"kind":"Variable","name":{"kind":"Name","value":"helpfulness"}}},{"kind":"Argument","name":{"kind":"Name","value":"difficultyRate"},"value":{"kind":"Variable","name":{"kind":"Name","value":"difficultyRate"}}},{"kind":"Argument","name":{"kind":"Name","value":"typeRate"},"value":{"kind":"Variable","name":{"kind":"Name","value":"typeRate"}}},{"kind":"Argument","name":{"kind":"Name","value":"relevance"},"value":{"kind":"Variable","name":{"kind":"Name","value":"relevance"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"helpfulness"}},{"kind":"Field","name":{"kind":"Name","value":"difficultyRate"}},{"kind":"Field","name":{"kind":"Name","value":"typeRate"}},{"kind":"Field","name":{"kind":"Name","value":"relevance"}}]}}]}}]} as unknown as DocumentNode<RateQuestionMutation, RateQuestionMutationVariables>;
