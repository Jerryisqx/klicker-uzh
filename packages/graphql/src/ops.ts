...
export type UploadFileApiMutationVariables = Exact<{ [key: string]: never; }>;
...
export const UploadFileApiDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UploadFileAPI"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uploadFile"}}]}}]} as unknown as DocumentNode<UploadFileApiMutation, UploadFileApiMutationVariables>;
